...
### FOR PULSE AT 500:
![image](https://github.com/nkishore2210/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118707090/b730f4ef-6848-4178-af7b-412713e61ca0)
```
  TON  = 2ms
  TOFF = 2ms
  TOTAL TIME = 4 
...
### FOR PULSE AT 700:
![image](https://github.com/nkishore2210/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118707090/514fa597-df66-4ac9-96b0-1bb886227041)
```
TON  = 2.17ms
TOFF = 0.93ms
TOTAL TIME = 3.1 
...
### FOR PULSE AT 900:
![image](https://github.com/nkishore2210/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118707090/422d1e51-2a3d-47eb-ad71-1165a3c4345f)
```
TON  = 2.88ms
TOFF = 0.32ms
TOTAL TIME = 3.2 
